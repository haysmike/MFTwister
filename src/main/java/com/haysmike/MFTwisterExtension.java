  ...
  public void init() {
    ...
    for (int i = 0; i < numControls; i++) {
      ...
      relativeHardwareKnob.setAdjustValueMatcher(
          midiIn.createRelativeBinOffsetCCValueMatcher(0, cc, maxMidiCcValue));
      relativeHardwareKnob
          .modulatedTargetValue()
          .addValueObserver(value -> sendMidiCc(0, cc, (int) (value * maxMidiCcValue)));
      relativeHardwareKnob
          .hasTargetValue()
          .addValueObserver(value -> sendMidiCc(2, cc, value ? 47 : 17));
      ...
      pressedAction.setBinding(
          host.createCallbackAction(
              () -> relativeHardwareKnob.setSensitivity(shiftedSensitivity),
      ...
      releasedAction.setBinding(
          host.createCallbackAction(
              () -> relativeHardwareKnob.setSensitivity(defaultSensitivity),
